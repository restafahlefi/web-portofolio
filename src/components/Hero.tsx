    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-zinc-300 mb-6">
        ...
        >
          <div className="relative w-72 h-72 md:w-96 md:h-96">
            {/* Image Wrapper */}
            <div className="relative w-64 h-64 md:w-80 md:h-80 mx-auto lg:mx-0 rounded-[3rem] overflow-hidden border-2 border-white/10 shadow-2xl group">
              <Image 
            ...
            {/* Animated Glow Rings */}
            <div className="absolute inset-0 -z-0 bg-blue-500/10 blur-[80px] animate-pulse rounded-full" />
            
            {/* Floating Badges */}
            <motion.div 
              animate={{ y: [0, -15, 0] }}
              transition={{ repeat: Infinity, duration: 4, ease: "easeInOut" }}
              className="absolute -top-4 -right-4 glass-card px-4 py-3 rounded-2xl flex items-center gap-2 text-xs md:text-sm font-bold z-20"
            >
            ...
            <motion.div 
              ...
              className="absolute -bottom-4 -left-4 glass-card px-4 py-3 rounded-2xl flex items-center gap-2 text-xs md:text-sm font-bold z-20"
            >
              <span className="text-xl">🚀</span>
